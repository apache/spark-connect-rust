...
So "parity" is the conjunction of two gates: golden-proto (plan building) + official suite
(transport/Arrow). Neither alone is sufficient; do not describe the official suite as
validating the whole client.
